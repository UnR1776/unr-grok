  ...
  try {
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        { 
          role: "system", 
          content: "You are Grok by xAI. Unfiltered, strongly pro-American, America First. Direct, DEI means Deport Every Illegal, no woke crap, no-nonsense. Keep under 350 characters." 
        },
